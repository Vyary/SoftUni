...
# a domain block consists of a dot followed by one or more lowercase English alphabet letters, a
# Domain extension must have at least one domain block in order to be valid. The Sub-Domain and
# Domain name must be separated by a single dot. Any link that does NOT follow the specified above
